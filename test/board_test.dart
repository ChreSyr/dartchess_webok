...
void main() {
  ...
  test('setPieceAt', () {
    ...
    expect(board.occupied, IraSquareSet(BigInt.parse('0x0000000000000001')));
    ...
    expect(board2.white, IraSquareSet(BigInt.parse('0x100000000000FFFF')));

    expect(board2.black, IraSquareSet(BigInt.parse('0xEFFF000000000000')));
    expect(board2.pawns, IraSquareSet(BigInt.parse('0x00FF00000000FF00')));
    expect(board2.knights, IraSquareSet(BigInt.parse('0x4200000000000042')));
    expect(board2.bishops, IraSquareSet(BigInt.parse('0x2400000000000024')));
    expect(board2.rooks, IraSquareSet.corners);
    expect(board2.queens, IraSquareSet(BigInt.parse('0x0800000000000008')));
    expect(board2.kings, IraSquareSet(BigInt.parse('0x1000000000000010')));
  });
